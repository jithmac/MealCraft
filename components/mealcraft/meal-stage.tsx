  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 p-3 rounded-2xl bg-card/40 backdrop-blur-sm">
        ...
        <div className="text-sm font-medium text-primary">${totalCost.toFixed(2)}</div>
      </div>
        ...
        >
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-between mt-2 text-xs text-muted-foreground">
              ...
              <span className="text-primary font-medium">${mealPlan.breakfast.cost}</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-between mt-2 text-xs text-muted-foreground">
              ...
              <span className="text-primary font-medium">${mealPlan.lunch.cost}</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-between mt-2 text-xs text-muted-foreground">
              ...
              <span className="text-primary font-medium">${mealPlan.dinner.cost}</span>
            </div>
          </div>
        </motion.div>
      </div>
