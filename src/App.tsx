...
const sampleMealPlan: MealPlan = {
  breakfast: { name: 'Avocado Toast with Eggs', calories: 450, cost: 8 },
  lunch: { name: 'Mediterranean Quinoa Bowl', calories: 620, cost: 12 },
  dinner: { name: 'Grilled Salmon with Vegetables', calories: 580, cost: 18 },
}
...
export default function App() {
  ...
  const isLowBudget = preferences.budget < 30
